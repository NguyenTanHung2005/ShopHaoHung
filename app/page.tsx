  ...
  return (
    <div className="space-y-16">
      ...
      <section id="featured" className="space-y-6">
        <div className="flex items-end justify-between gap-4">
          <div>
            ...
            <h2 className="text-3xl font-bold tracking-tight text-slate-950">Vợt nổi bật nhất</h2>
          </div>
      ...
      <section className="rounded-[2rem] bg-slate-100 p-8 text-center lg:p-12">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-slate-600">Khám phá bộ sưu tập vợt cầu lông chuyên nghiệp và ống cầu lông chất lượng cao từ các thương hiệu hàng đầu thế giới.</p>
        <div className="mt-8">
          <Link href="/shop">
            <Button variant="primary" size="lg">
              Khám phá sản phẩm
