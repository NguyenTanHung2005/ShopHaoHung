      ...
      <nav className="container mx-auto flex items-center justify-between px-4 py-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            ...
            className="relative flex h-11 w-11 items-center justify-center rounded-full border border-white/10 bg-white/5 text-white/80 transition hover:bg-white/10 hover:text-white"
            aria-label="Giỏ hàng"
          >
            <CartIcon />
          ...
          {isHydrated && isAuthenticated ? (
            ...
            <>
              ...
              <Link
                href="/auth/signup"
                className="rounded-full bg-gradient-to-r from-emerald-400 to-cyan-400 px-5 py-2 text-sm font-semibold text-slate-950 shadow-lg shadow-emerald-500/20 transition hover:scale-[1.03]"
              >
                Đăng ký
              </Link>
            </>
